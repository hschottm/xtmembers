...
$GLOBALS['TL_LANG']['tl_module']['memberlist_filtercount']       = array('Number of filter selections', 'Enter the number of available filter selections. The number must not be greater than the number of filter conditions.');
